 ...
 * La multiplicaci�n por escalar de una matriz, cA = B, se define como B(i,j) = c * A(i,j)
 **/
 ...
 * La multiplicaci�n de dos matrices es v�lida si el n�mero de columnas de la primera es igual el n�mero de filas de la segunda.
 * La multiplicaci�n AxB=C se define como C(i,k) = A(i,j)*B(j,k)
 **/
